...
<<<<<<< HEAD
        Udyam Setu <span className="text-xs font-semibold px-2 py-0.5 bg-primary-50 text-primary-700 rounded border border-primary-200 uppercase tracking-wider">{t('PROTOTYPE')}</span>
=======
<<<<<<< Updated upstream
